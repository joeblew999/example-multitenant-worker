 ...
 *
 * Structurally mirrors Kumo's theme-fedramp.css (single @layer base
 * block scoped to [data-theme="editorial"]). Values reference vars
 * from legacy-styles.css which handles light/dark via prefers-color-scheme.
 */
`;
